...
void test_mse_perfect_prediction(void) {
    ...
    tensor_set(pred, 0, 0, 1.0);
    tensor_set(pred, 0, 1, 2.0);
    tensor_set(pred, 0, 2, 3.0);
    tensor_set(target, 0, 0, 1.0);
    tensor_set(target, 0, 1, 2.0);
    tensor_set(target, 0, 2, 3.0);
...
void test_mse_known_value(void) {
    ...
    tensor_set(pred, 0, 0, 1.0);
    tensor_set(pred, 0, 1, 0.0);
    tensor_set(target, 0, 0, 0.0);
    tensor_set(target, 0, 1, 1.0);
...
void test_cross_entropy_known_value(void) {
    ...
    Tensor *pred = tensor_create(1, 2);
    Tensor *target = tensor_create(1, 2);
    tensor_set(pred, 0, 0, 0.9);
    tensor_set(pred, 0, 1, 0.1);
    tensor_set(target, 0, 0, 1.0);
